...
INSERT INTO `log_activity` (`id`, `username`, `action`, `created_at`) VALUES
(1, 'admin', 'Mengubah data obat: amoxilin (ID: 2)', '2026-06-23 17:21:36');
...
(2, 'amoxilin', 'rendah', 30000.00, 90000.00, 20, '2026-03-10 19:35:02', 'Tablet', 10, 'rak', '2026-07-02', 'kategori', '123'),
(3, 'onat', 'jenis', 300000.00, 2000.00, 203, '2026-06-23 16:52:57', 'Strip', 10, 'rak', '2027-01-01', 'kategori', NULL);
...
INSERT INTO `stok_opname` (`id`, `obat_id`, `stok_sistem`, `stok_fisik`, `selisih`, `keterangan`, `created_at`, `updated_at`) VALUES
(1, 2, 2, 12, -10, 'Lebih', '2026-06-23 16:51:17', '2026-06-23 16:51:17');
